...
<div class="sidebar">
  ...
  <ul>
    ...
    <li><a class="active" href="{{url('admin/masyarakat')}}">Daftar Masyarakat</a></li>
    ...
    <li style="float:right;"><p style="color:white">{{Session::get('username')}}</p></li>
      ...
      <div>
        <div>
          ...
          <h1>
            <font color="white"><p style="text-align:center">
              DAFTAR MASYARAKAT
            </p></font>
          </h1>
        ...
        href="{{url('admin/masyarakat/cetak')}}">Cetak Data Petugas(PDF)</a>
