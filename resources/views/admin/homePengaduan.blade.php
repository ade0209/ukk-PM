    ...
    <li style="float:right"><p style="color:white">{{Session::get('username')}}</p></li>
      ...
      <div>
        <div class="content">
            ...
            <font color="white"><h1 style="text-align:center">DAFTAR PENGADUAN </h1></font>
            ...
            <font color="white"><h1>Pengaduan belum di tanggapi</h1></font>
            ...
            <font color="white"><h1>Pengaduan telah di tanggapi</h1></font>
