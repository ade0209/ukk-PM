  ...
  padding: 10px;
    ...
    <section class="main-section">
        ...
        <div class="content">
            ...
            <font color="white"><h1>FORMULIR PENGADUAN </h1></font>
    ...
    @csrf
      @if(!empty($pengaduan))
        @method('PATCH')
      @endif
        <font color="white"><p> Isi Laporan : </p></font><input style="padding: 12px 20px;font-size: 16px;font-family:'Nexa-Regular';width: 70%;
        ...
        <font color="white"><p> Foto : </p></font><input type="file" name="foto" id="foto" value="{{old('foto',@$pengaduan->foto)}}" {{old('foto',@$pengaduan->foto)}}><br>
        @if(!empty($pengaduan))
      <div>
